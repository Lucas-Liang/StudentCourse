...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span12">
			...
			<br>
			<s:form action ="school_save" method = "post" namespace ="/" them ="simple">
				<div class="control-group">
					
					<div class="controls">
						 <label class="control-label" for="inputEmail">学校名称</label>&nbsp;&nbsp;&nbsp;<input id="inputEmail" type="text" name="s_name"/>
					</div>
				</div>
				<br>
				<div class="control-group">
					...
					<div class="controls">
						 <label class="control-label" for="inputPassword">学校地址</label>&nbsp;&nbsp;&nbsp;<input id="inputPassword" type="text" name="s_address" />
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
